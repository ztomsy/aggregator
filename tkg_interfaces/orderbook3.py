...
class simpleOrderbook(object):
    '''
    simpleOrderbook tracks returned obs from an exchange

    Orderbook is a set of linked lists and dictionaries containing bids and asks.
    Orderbook also provides methods maintaining a history of the book.
    Public attributes:
    Public methods: report_top_of_book()
    '''
    def __init__(self):
        '''
...
class Orderbook(object):
    ...
    def add_order_to_history(self, order):
        ...
        self.order_history.append(
            {'exid': self._order_index, 'order_id': order['order_id'], 'trader_id': order['trader_id'],
    ...
    def _add_trade_to_book(self, resting_trader_id, resting_order_id, resting_timestamp,
        ...
        self.trade_book.append({'resting_trader_id': resting_trader_id, 'resting_order_id': resting_order_id,
                                'resting_timestamp': resting_timestamp,
                                'incoming_trader_id': incoming_trader_id, 'incoming_order_id': incoming_order_id,
                ...
                if book_prices:
                    ...
                    if order['price'] >= price:
                        ...
                        if remainder >= book_order['quantity']:
                            ...
                            self._add_trade_to_book(book_order['trader_id'], book_order['order_id'],
                                                    book_order['timestamp'],
